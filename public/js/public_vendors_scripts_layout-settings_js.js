(self["webpackChunk"] = self["webpackChunk"] || []).push([["public_vendors_scripts_layout-settings_js"],{

/***/ "./public/vendors/scripts/layout-settings.js":
/*!***************************************************!*\
  !*** ./public/vendors/scripts/layout-settings.js ***!
  \***************************************************/
/***/ (() => {
...
(function () {
  ...
  $(document).ready(function () {
    ...
    function setOptions(propertyName, propertyValue) {
      ...
      optionsCopy[propertyName] = propertyValue; //Store in local storage
    ...
    var left_sidebar = jQuery('.left-side-bar'); // Header Background
    ...
    header_dark.click(function () {
      ...
      body.removeClass('header-white').addClass('header-dark'); //Store in local storage
    ...
    header_light.click(function () {
      ...
      body.removeClass('header-dark').addClass('header-white'); //Store in local storage
    ...
    sidebar_dark.click(function () {
      ...
      body.removeClass('sidebar-light').addClass('sidebar-dark'); //Store in local storage
    ...
    sidebar_light.click(function () {
      ...
      body.removeClass('sidebar-dark').addClass('sidebar-light'); //Store in local storage
