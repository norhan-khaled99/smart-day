          ...
          <table class="table" id="printMe">
            <thead>
              <tr>
                ...
                <th scope="col">{{ $t("Certificates") }}</th>
                <th scope="col">{{ $t("EXPERIENCE") }}</th>
...
import recruitmentClient from "../../../http-clients/admin/recruitment-client";
...
export default {
  ...
  setup() {
    ...
    function downloadExcelFile() {
      recruitmentClient.getAllItems().then((res) => {
        let data = res.data;
